...
public class UtilPropPrakash {
   ...
   static String _PROP_FILENAME_OSX_LOCAL = "/Users/prakashns/Documents/INTRO-TO-SOFTWARE-ENGINEERING/workspace4830_fall2023/workspace4830-te-Prakash/SoccerDatabase/src/main/webapp/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/SoccerDatabase/config.properties";
